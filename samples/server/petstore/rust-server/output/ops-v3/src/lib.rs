...
pub trait ApiNoContext {
    ...
    fn op10_get(&self) -> Box<Future<Item=Op10GetResponse, Error=ApiError> + Send>;


    fn op11_get(&self) -> Box<Future<Item=Op11GetResponse, Error=ApiError> + Send>;


    fn op12_get(&self) -> Box<Future<Item=Op12GetResponse, Error=ApiError> + Send>;


    fn op13_get(&self) -> Box<Future<Item=Op13GetResponse, Error=ApiError> + Send>;


    fn op14_get(&self) -> Box<Future<Item=Op14GetResponse, Error=ApiError> + Send>;


    fn op15_get(&self) -> Box<Future<Item=Op15GetResponse, Error=ApiError> + Send>;


    fn op16_get(&self) -> Box<Future<Item=Op16GetResponse, Error=ApiError> + Send>;


    fn op17_get(&self) -> Box<Future<Item=Op17GetResponse, Error=ApiError> + Send>;


    fn op18_get(&self) -> Box<Future<Item=Op18GetResponse, Error=ApiError> + Send>;


    fn op19_get(&self) -> Box<Future<Item=Op19GetResponse, Error=ApiError> + Send>;


    fn op1_get(&self) -> Box<Future<Item=Op1GetResponse, Error=ApiError> + Send>;


    fn op20_get(&self) -> Box<Future<Item=Op20GetResponse, Error=ApiError> + Send>;


    fn op21_get(&self) -> Box<Future<Item=Op21GetResponse, Error=ApiError> + Send>;


    fn op22_get(&self) -> Box<Future<Item=Op22GetResponse, Error=ApiError> + Send>;


    fn op23_get(&self) -> Box<Future<Item=Op23GetResponse, Error=ApiError> + Send>;


    fn op24_get(&self) -> Box<Future<Item=Op24GetResponse, Error=ApiError> + Send>;


    fn op25_get(&self) -> Box<Future<Item=Op25GetResponse, Error=ApiError> + Send>;


    fn op26_get(&self) -> Box<Future<Item=Op26GetResponse, Error=ApiError> + Send>;


    fn op27_get(&self) -> Box<Future<Item=Op27GetResponse, Error=ApiError> + Send>;


    fn op28_get(&self) -> Box<Future<Item=Op28GetResponse, Error=ApiError> + Send>;


    fn op29_get(&self) -> Box<Future<Item=Op29GetResponse, Error=ApiError> + Send>;


    fn op2_get(&self) -> Box<Future<Item=Op2GetResponse, Error=ApiError> + Send>;


    fn op30_get(&self) -> Box<Future<Item=Op30GetResponse, Error=ApiError> + Send>;


    fn op31_get(&self) -> Box<Future<Item=Op31GetResponse, Error=ApiError> + Send>;


    fn op32_get(&self) -> Box<Future<Item=Op32GetResponse, Error=ApiError> + Send>;


    fn op33_get(&self) -> Box<Future<Item=Op33GetResponse, Error=ApiError> + Send>;


    fn op34_get(&self) -> Box<Future<Item=Op34GetResponse, Error=ApiError> + Send>;


    fn op35_get(&self) -> Box<Future<Item=Op35GetResponse, Error=ApiError> + Send>;


    fn op36_get(&self) -> Box<Future<Item=Op36GetResponse, Error=ApiError> + Send>;


    fn op37_get(&self) -> Box<Future<Item=Op37GetResponse, Error=ApiError> + Send>;


    fn op3_get(&self) -> Box<Future<Item=Op3GetResponse, Error=ApiError> + Send>;


    fn op4_get(&self) -> Box<Future<Item=Op4GetResponse, Error=ApiError> + Send>;


    fn op5_get(&self) -> Box<Future<Item=Op5GetResponse, Error=ApiError> + Send>;


    fn op6_get(&self) -> Box<Future<Item=Op6GetResponse, Error=ApiError> + Send>;


    fn op7_get(&self) -> Box<Future<Item=Op7GetResponse, Error=ApiError> + Send>;


    fn op8_get(&self) -> Box<Future<Item=Op8GetResponse, Error=ApiError> + Send>;


    fn op9_get(&self) -> Box<Future<Item=Op9GetResponse, Error=ApiError> + Send>;
